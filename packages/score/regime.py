...
def weekly_view() -> dict:
    ...
    return {
        ...
        "india": india,
        # sector_tape lived here 2026-09-03 .. 2026-09-04, removed at the
        # PM's instruction; the nine index series keep accruing, so a
        # restore is a code change, not a data recovery.
